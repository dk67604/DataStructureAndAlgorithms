package educative.io.coding.twopointers;
...
public class BackspaceCompare {
    public static boolean compare(String str1, String str2) {
        ...
        while (index1 >= 0 || index2 >=0 ){
            ...
            if(i1 < 0 && i2 < 0) //reached at the end of both the strings
                return true;
            if(i1 < 0 || i2 < 0) //reached at the end of one of the strings
                return false;
            if(str1.charAt(i1) != str2.charAt(i2)) //check if the character are equal
                return false;
